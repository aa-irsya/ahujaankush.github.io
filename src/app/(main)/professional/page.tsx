...
export default function Professional() {
    return (
        <main className="flex flex-col grow items-center px-6 md:px-0 mt-20">
            <Section>
                <div className="absolute mt-[-20vmax] right-[-20vmax] w-[40vmax] h-[40vmax] rounded-full green-circle" />
                ...
                <div className="absolute mt-[-10vmax] left-[-20vmax] w-[30vmax] h-[30vmax] rounded-full red-circle" />
            </Section>
        </main>
    );
}
